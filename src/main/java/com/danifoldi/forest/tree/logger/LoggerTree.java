...
public class LoggerTree implements Tree {
    ...
    public @NotNull CompletableFuture<?> load() {
        return CompletableFuture.runAsync(() -> {
            ...
            NamespacedMultiDataVerse<LogEntry> logDataverse = DataVerse.getDataVerse().getNamespacedMultiDataVerse(DataverseNamespace.get(), "logger_%s".formatted(TreeLoader.getServerId()), LogEntry::new);
